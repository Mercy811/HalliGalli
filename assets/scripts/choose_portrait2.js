...
cc.Class({
    ...
    update: function (dt) {
        ...
        if(num === 5){
            console.log("num === 5");
            console.log(this.node.name);
            cc.loader.loadRes("5",cc.SpriteFrame,function(err,ret){
                if(err){
                    console.log(err);
                    return;
                }
        ...
        if(num === 6){
            console.log("num === 6");
            console.log(this.node.name);
            cc.loader.loadRes("6",cc.SpriteFrame,function(err,ret){
                if(err){
                    console.log(err);
                    return;
                }
        ...
        if(num === 7){
            console.log("num === 7");
            console.log(this.node.name);
            cc.loader.loadRes("7",cc.SpriteFrame,function(err,ret){
                if(err){
                    console.log(err);
                    return;
                }
        ...
        if(num === 8){
            console.log("num === 8");
            console.log(this.node.name);
            cc.loader.loadRes("8",cc.SpriteFrame,function(err,ret){
                if(err){
                    console.log(err);
                    return;
                }
